        ...
        <div class="col-md-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="smartphone.php" class="btn btn-primary">Lihat Smartphone</a>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="computer.php" class="btn btn-primary">Lihat Computer</a>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="apple.php" class="btn btn-primary">Lihat Apple</a>
                    </div>
                </div>
            </div>
        </div>
